! function () {
  ...
  if ((e = document.getElementById("site-navigation")) && void 0 !== (t = e.getElementsByTagName("button")[0]))
    if (void 0 !== (a = e.getElementsByTagName("ul")[0])) {
      for (a.setAttribute("aria-expanded", "false"), -1 === a.className.indexOf("nav-menu") && (a.className += " nav-menu"), t.onclick = function () {
        ...
        }, n = 0, l = (s = a.getElementsByTagName("a")).length; n < l; n++) s[n].addEventListener("focus", i, !0), s[n].addEventListener("blur", i, !0);
      ! function (e) {
        let t, a, s = e.querySelectorAll(".menu-item-has-children > a, .page_item_has_children > a");
        if ("ontouchstart" in window)
          for (t = function (e) {
              let t, a = this.parentNode;
            ...
            }, a = 0; a < s.length; ++a) s[a].addEventListener("touchstart", t, !1)
      }(e)
